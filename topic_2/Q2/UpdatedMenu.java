...
public class UpdatedMenu{
    ...
    public static void main(String [] args){
        ...
        while (true) {
            System.out.print("Enter [a, b, c, d, e, f, q]: ");
            char in;
    ...
    static void tenNumArray(){
        // function to prompt for 10 integer and put it in an array
        // param None
        // return None
    ...
    static void disHiLoAvg(int [] nums){
        // function to display highest, lowest, average number from the array
